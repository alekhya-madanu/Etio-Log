...
const data = [{feeling:'happy',intensity:5},{feeling:'angry',intensity:4},{feeling:'anxious',intensity:5}]
console.log(data);

const y = (d: Feeling) => d.intensity;
...
export default function Example({ width, height, levels = 10, margin = defaultMargin }: RadarProps) {
